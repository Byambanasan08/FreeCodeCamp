...
1.1 Single page applications (SPAs) are web applications that load a single HTML page and dynamically update that page as the user interacts with the application without reloading the entire page.
...
2.1 Importing and Exporting React components
...
2.2 Setting up a React project using Vite
...
2.3 Passing props in React components
...
2.4 Conditional rendering in React
