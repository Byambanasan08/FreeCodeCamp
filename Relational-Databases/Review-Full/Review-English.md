...
Working with Repositories
    ...
    Initialize an empty git repository in the project directory (git init).
    Make changes to your project.
    Run the git status command to see all changes made that are being tracked by git.
    Stage your changes (git add).
    Commit your changes (git commit).
    Setup the remote connection (git remote add).
