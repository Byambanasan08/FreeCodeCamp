...
2.1 Heading Elements: There are six heading elements in HTML. The h1 through h6 heading elements are used to signify the importance of content below them. The lower the number, the higher the importance, so h2 elements have less importance than h1 elements.
Example Code
...
2.2 Paragraph Elements: This is used for paragraphs on a web page.
Example Code
<p>This is a paragraph element.</p>

2.3 img Elements: The img element is used to add images to the web page. The src attribute is used to specify the location for that image. For image elements, it's good practice to include another attribute called the alt attribute. Here's an example of an img element with the src and alt attributes:
Example Code
<img src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/lasagna.jpg" alt="A slice of lasagna on a plate.">

2.4 body Element: This element is used to represent the content for the HTML document.
Example Code
<body>
  <h1>CatPhotoApp</h1>
  <p>This is a paragraph element.</p>
...
2.5 section Elements: This element is used to divide up content into smaller sections.
Example Code
<section>
  <h2>About Me</h2>
...
2.6 div Elements: This element is a generic HTML element that does not hold any semantic meaning. It is used as a generic container to hold other HTML elements.
Example Code
<div>
...
2.7 Anchor (a) Elements: These elements are used to apply links to a web page. The href attribute is used to specify where the link should go when the user clicks on it.
Example Code
<a href="https://cdn.freecodecamp.org/curriculum/cat-photo-app/running-cats.jpg">cute cats</a>

2.8 Unordered (ul) and Ordered (ol) List Elements: To create a bulleted list of items you should use the ul element with one or more li elements nested inside like this:
Example Code
<ul>
  <li>catnip</li>
...
2.9 To create an ordered list of items you should use the ol element:
Example Code
<ol>
...
2.10 Emphasis (em) Element: This is used to place emphasis on a piece of text.
Example Code
<p>Cats <em>love</em> lasagna.</p>  

2.11 Strong Importance (strong) Element: This element is used to place strong emphasis on text to indicate a sense of urgency and seriousness.
Example Code
<p>
  <strong>Important:</strong> Before proceeding, make sure to wear your safety goggles. 
</p>

2.12 figure and figcaption Elements: The figure element is used to group content like images and diagrams. The figcaption element is used to represent a caption for that content inside the figure element.
Example Code
<figure>
...
2.13 main Element: This element is used to represent the main content for a web page.

2.14 footer Element: This element is placed at the bottom of the HTML document and usually contains copyright information and other important page links.
Example Code
<footer>
  <p>
...
4. Special Characters and Linking
...
5. script Element: This element is used to embed executable code.
Example Code
<body>
  <script>
...
6.1 og:title Property: This is used to set the title that displays for social media posts.
Example Code
<meta content="freeCodeCamp.org" property="og:title" />

6.2 og:type Property: The type property is used to represent the type of content being shared on social media. Examples of this content include articles, websites, videos, or music.
Example Code
<meta property="og:type" content="website" />

6.3 og:image Property: This is used to set the image shown for social media posts.
Example Code
<meta
  content="https://cdn.freecodecamp.org/platform/universal/fcc_meta_1920X1080-indigo.png"
  property="og:image"
/>
6.4 og:url Property: This is used to set the URL that users will click on for the social media posts.
Example Code
<meta property="og:url" content="https://www.freecodecamp.org" />
---

7. Media Elements and Optimization
