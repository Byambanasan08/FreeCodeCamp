...
p tabindex=-1Sorry, there was an error with your submission.p
...
button accesskey=sSavebutton
button accesskey=cCancelbutton
a href=index.html accesskey=hHomea
...
button type=button id=search-btnSearchbutton
...
button
    i class=fa-solid fa-gear aria-hidden=truei
    span class=labelSettingsspan
button
...
form
    ...
    p id=password-helpYour password must be at least 8 characters long.p
form
