...
1. Comparisons and the null and undefined Data Types
...
console.log(undefined >= 0); // false (NaN >= 0 is false)
    ...
    1.2 Comparisons and null: The null type represents the intentional absence of a value. null converts to 0 in numeric contexts, which may result in unexpected behavior in numeric comparisons:
